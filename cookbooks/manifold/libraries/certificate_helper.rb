...
class CertificateHelper
  ...
  # Get all files in /opt/manifold/embedded/ssl/certs
  # - "cacert.pem", "README" -> ignore
  # - if valid certificate
  #   - if symlink
  #     - remove broken symlinks
  #     - ignore if pointing to /etc/manifold/trusted-certs
  ...
  def c_rehash
    cmd = "/opt/manifold/embedded/bin/c_rehash #{@trusted_certs_dir}"
